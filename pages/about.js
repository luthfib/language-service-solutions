            ...
            innerText={
              <>
                <p className="no-margin-top">
                  Language Service Solutions, LLC has over 20 years of experience providing translations,
                  interpretation, and consulting around language services for organizations and communities. Our focus
                  on facilitating meaningful community connections, eliminating language barriers and generating equity
                  make us one of the most trusted full-service language providers in the Triangle. We work to ensure
                  everyone’s voices are truly heard and included. Our company promotes best practices for creating
                  inclusive multilingual spaces where all languages are valued equally and speakers of different
                  languages benefit from listening to and sharing with one other..
                </p>
                <br />
                <p className="no-margin-top">
                  Our professional, friendly and experienced team works hard to provide our clients with the best
                  service. We are bi-cultural/bilingual group of professionals who understand the subtle cultural
                  difference that play a role in communication.
                </p>
                <br />
              </>
            }
            ...
            innerText={
              <>
                ...
                <p className="no-margin-top">
                  ...
                  strict ethical standards while providing one of the most affordable services in the area. With more
                  than 15 years of experience in this field, we work ardently to bring a professional standard of
                ...
                <p className="no-margin-top">
                  We believe that trust is essential in all of our business relationships. Therefore, we will never
                  share information with anyone. Your files will be restricted and password-protected. We maintain a
