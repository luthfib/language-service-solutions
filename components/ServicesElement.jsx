    ...
    return (
        <>
            <div className="services bg-wheat rounded-3xl w-full p-16 md:px-14">
                ...
                >
                    <div className="relative opacity-100 transition-all duration-500 ease-in delay-100 lg:even:pt-[100px] telephone">
                        <Link
                    ...
                    <div
                        className="relative opacity-100 transition-all duration-500 ease-in delay-100 lg:even:pt-[100px] translatio"
                    >
                        <Link
                    ...
                    <div className="relative opacity-100 transition-all duration-500 ease-in delay-100 lg:even:pt-[100px] in-perso">
                        <Link
                    ...
                    <div
                        className="relative opacity-100 transition-all duration-500 ease-in delay-100 lg:even:pt-[100px] transcription"
                    >
                        <Link
                    ...
                    <div className="relative opacity-100 transition-all duration-500 ease-in delay-100 lg:even:pt-[100px] sub">
                        <Link
                ...
                <div className="flex justify-center">
                    <Button link={'/services/'} text={'View all services'} />
                </div>
            </div>
        </>
    );
