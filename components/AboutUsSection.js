	...
	<>
		<div className='about-holder'>
			<div className='about-us'>
				...
				<p>
					Our professional, friendly, and experienced team works hard to provide our clients with
					the best service. We are bi-cultural/bilingual group of professionals who understand the
					subtle cultural differences that play a role in communication
				</p>
			</div>
		</div>
		<style jsx>{`
