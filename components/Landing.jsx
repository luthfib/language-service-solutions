        ...
        <div className={styles.landing}>
            ...
            >
                <g id="Layer_1-2" data-name="Layer 1">
                    ...
                    <circle
                        className={`${styles.cls13} ${styles.bounce}`}
                        cx="588.76"
                        cy="343.17"
                        r="21.95"
                    />
                    <circle
                        className={`${styles.cls24} ${styles.bounce}`}
                        cx="348.22"
                        cy="891.21"
                        r="16.35"
                    />
                    <circle
                        className={`${styles.cls26} ${styles.bounce}`}
                        cx="598.79"
                        cy="529.07"
                        r="16.35"
                    />
                    <circle
                        className={`${styles.cls18} ${styles.bounce}`}
                        cx="210.39"
                        cy="979.3"
                        r="25.57"
                    />
                    ...
                    />
                    <circle
                        className={`${styles.cls20} ${styles.bounce}`}
                        cx="250.44"
                        cy="1012.15"
                        r="12.38"
                    />
                    <circle
                        className={`${styles.cls23} ${styles.bounce}`}
                        cx="206.54"
                        cy="683.84"
                        r="12.38"
                    />
                    ...
                    />
                    <path
                        className={`${styles.cls33} ${styles.handShade}`}
                    ...
                    />
                    <path
                        className={`${styles.cls25} ${styles.handShade}`}
                    ...
                    />
                    <path
                        className={`${styles.cls28} ${styles.handShade}`}
                        style={{ '--data-opacity': 0.2 }}
                    ...
                    />
                    <path
                        className={`${styles.cls32} ${styles.fadeIn}`}
                        style={{ '--data-opacity': 0.2 }}
                    ...
                    />
                    <path
                        className={`${styles.cls29} ${styles.handShade}`}
                    ...
                    <g className={styles.firstHand}>
                        ...
                        />
                        <path
                            className={`${styles.cls31} ${styles.handShade}`}
                    ...
                    />
                    <circle
                        className={`${styles.cls16} ${styles.bounce}`}
                        cx="1540.27"
                        cy="322.74"
                        r="29.35"
                    />
                    ...
                    />
                    <circle
                        className={`${styles.cls1} ${styles.bounce}`}
                        cx="292.44"
                        cy="1382.9"
                        r="16.35"
                    />
                    <circle
                        className={`${styles.cls4} ${styles.bounce}`}
                        cx="566.8"
                        cy="224.12"
                        r="25.57"
                    />
                    <circle
                        className={`${styles.cls3} ${styles.bounce}`}
                        cx="1827.67"
                        cy="495.66"
                        r="18.08"
                    />
