...
export default css.global`
  :root {
    ...
    --elevation-3-yellow-light: 0 10px 20px rgba(var(--rgb-yellow-light), 0.17),
    ...
    --elevation-3-green-light: 0 10px 20px rgba(var(--rgb-green-light), 0.17),
      0 6px 6px rgba(var(--rgb-green-light), 0.17);
    --elevation-3-green-darker: 0 10px 20px rgba(var(--rgb-green-darker), 0.17),
